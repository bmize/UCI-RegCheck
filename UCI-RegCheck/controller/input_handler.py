...
class InputHandler:
    ...
    def __init__(self):
        """
        :param _commands: Set of integers corresponding to the numbers in
         view.menu.display_main_menu()
        :param _course_scraper: CourseScraper object used for gathering and
    ...
    def receive_input(self):
        """Primary loop for continuously receiving user input until program
         is exited.
